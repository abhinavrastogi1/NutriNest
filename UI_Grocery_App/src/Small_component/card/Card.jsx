  ...
  return (
    <div className="h-[551px] w-[270px] p-[10px] my-5 bg-white" key={Card.id}>
      ...
      <div className="flex flex-row gap-2 h-5">
        ...
        <h6 className="line-through text-gray-600 text-sm pt-[2px] ">
          {" "}
          {`₹${previousPrice}`}
        </h6>
      </div>
      ...
      <div>
        <div className="bg-gradient-to-l from-[rgb(228,241,204)] to-[rgba(255,255,255,1)] h-[30px] border-[1px] border-[#ADD566]">
          <button className="flex flex-row justify-around">
            ...
            <span>
              <img className="h-5" src={greenarrowdown} />
            </span>
          </button>
        </div>
      </div>
      <div className="flex flex-row justify-around gap-4">
        <button className="h-[35px] w-[15%]   rounded-md border-[1px] border-gray-600">
          <img className="h-5 w-5 ml-[7px]" src={savelater} />
        </button>
