...
<footer className="bg-[#101010]">
  <div className="mx-48 grid grid-cols-3 ">
   <diV className="pt-12">
    <div>
      <h4 className=" text-white  text-[14px] font-normal pl-3 ">Bigbasket</h4>
    </div>
   ...
   <li className="hover:underline"><a href="./">Become A bigbasket Rider</a> </li>
   <li className="hover:underline"><a href="./">In News</a></li>
   <li className="hover:underline"><a href="./">Green bigbasket</a></li>
   <li className="hover:underline"><a href="./">privacy Policy</a></li>
   <li className="hover:underline"><a href="./">Terms and conditions</a></li>
   <li className="hover:underline"><a href="./">Careers At bigbasket</a></li>
   <li className="hover:underline"><a href="./">bb Instant</a></li>
   <li className="hover:underline"><a href="./">bb Daily</a></li>
   <li className="hover:underline"><a href="./">bb Blog</a></li>
   <li className="hover:underline"><a href="./">bbnow</a></li>
   </ul>
   </diV>
   <diV className="pt-12">
    <div>
   ...
   <li className="hover:underline"><a href="./">bb Wallet FAQs</a></li>
   <li className="hover:underline"><a href="./">bb Wallet T&Cs</a></li>
   <li className="hover:underline"><a href="./">Vendor COntact</a></li>
  </ul>
   </diV>
   <div className="pt-12">
    <div>
    ...
    <div></div>
    <div>
      <div><img src={Facebook_logo} className="h-3 w-3 bg-black"/></div>
    </div>
   </div>
  </div>
  <div className="mx-48 border-dashed border-y-[1px] ">
<h4 className=" text-white text-center py-2 text-[14px] font-normal"> Cities we serve</h4>
<p class="flex flex-wrap items-center justify-cente text-white font-light text-[13px]">
...
<span>|</span>
<span className="mx-2 my-1 text-white">Baishnabghata-Patuli Township</span>
<span>|</span>
...
<span className="mx-2 my-1 text-white">Begusarai</span>
  ...
  <div className="grid">
  <h4 className=" text-white py-2 text-[14px] font-normal"> Popular categories</h4>
    <div className="grid grid-cols-3 ">
   <div>
      <ul className="text-white text-[13px] flex flex-col justify-between font-light py-2 space-y-1">
   <li className="hover:underline"><a href="./">Sunflower Oils</a></li>
   <li className="hover:underline"><a href="./">Milk</a> </li>
   <li className="hover:underline"><a href="./">Organic F&V</a></li>
   <li className="hover:underline"><a href="./">Floor Cleaner</a></li>
   <li className="hover:underline"><a href="./">Frozen Veg Food</a></li>
   
   </ul>
   </div>
   <div>
      <ul className="text-white text-[13px] flex flex-col justify-between font-light py-2 space-y-1">
   <li className="hover:underline"><a href="./">White Atta</a></li>
   <li className="hover:underline"><a href="./">Health Drinks</a> </li>
   <li className="hover:underline"><a href="./">Namkeen</a></li>
   <li className="hover:underline"><a href="./">Other Juices</a></li>
   <li className="hover:underline"><a href="./">Diapers & Wipes</a></li>
   </ul>
   </div>
   <div>
      <ul className="text-white text-[13px] flex flex-col justify-between font-light py-2 space-y-1">
   <li className="hover:underline"><a href="./">Ghee</a></li>
   <li className="hover:underline"><a href="./">Flakes</a> </li>
   <li className="hover:underline"><a href="./">Eggs</a></li>
   <li className="hover:underline"><a href="./">Leafy Vegitables</a></li>
   </ul>
   </div>
    </div>
  </div>
  <div className="grid">
  <h4 className=" text-white py-2 text-[14px] font-normal"> Popular Brands</h4>
    <div className="grid grid-cols-3 ">
   <div>
      <ul className="text-white text-[13px] flex flex-col justify-between font-light py-2 space-y-1">
   <li className="hover:underline"><a href="./">Amul</a></li>
   <li className="hover:underline"><a href="./">RED BULL</a> </li>
   <li className="hover:underline"><a href="./">Yummiez</a></li>
   <li className="hover:underline"><a href="./">Britannia</a></li>
   <li className="hover:underline"><a href="./">Haldiram's</a></li>
   
   </ul>
   </div>
   <div>
      <ul className="text-white text-[13px] flex flex-col justify-between font-light py-2 space-y-1">
   <li className="hover:underline"><a href="./">Nescafe</a></li>
   <li className="hover:underline"><a href="./">elite cake</a> </li>
   <li className="hover:underline"><a href="./">Yera</a></li>
   <li className="hover:underline"><a href="./">Wow! Momo</a></li>
   <li className="hover:underline"><a href="./">Ferrero</a></li>
   </ul>
   </div>
   <div>
      <ul className="text-white text-[13px] flex flex-col justify-between font-light py-2 space-y-1">
   <li className="hover:underline"><a href="./">MTR</a></li>
   <li className="hover:underline"><a href="./">Pediasure</a> </li>
   <li className="hover:underline"><a href="./">Yakult</a></li>
   <li className="hover:underline"><a href="./">Fortune</a></li>
   <li className="hover:underline"><a href="./">Lay's</a></li>
   </ul>
   </div>
    </div>
  </div>
...
<div className="flex flex-row justify-center " >
  <button className="text-white text-center font-light text-[13px] underline  ">Show More +</button>
</div>
</div>
<div className=" bg-black ">
<p className="text-white text-[13px] font-light py-3 pl-[13%]">
  <span>Copyright © 2023-2025 Supermarket Grocery Supplies Pvt Ltd
  </span>
</p>
</div>
</footer>
